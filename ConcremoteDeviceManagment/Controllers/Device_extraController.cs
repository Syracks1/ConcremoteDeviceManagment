...
namespace ConcremoteDeviceManagment.Controllers
{
    public class Device_extraController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,ConcremoteDevice_id,Price_id,Datum,Active,Eigenschap_id")] Device_extra_info device_extra)
        {
            if (ModelState.IsValid)
            {
                db.Device_extra_info.Add(device_extra);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,ConcremoteDevice_id,Price_id,Datum,Active,Eigenschap_id")] Device_extra_info device_extra)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            Device_extra_info device_extra = db.Device_extra_info.Find(id);
            db.Device_extra_info.Remove(device_extra);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
